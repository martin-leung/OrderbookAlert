class AlertSender:
    ...
    def send_empty_alert(self, instrument_name, current_time):
    ...
    def send_bids_empty_alert(self, instrument_name, current_time):
    ...
    def send_asks_empty_alert(self, instrument_name, current_time):
    ...
    def send_normal_alert(self, instrument_name, spread_percentage, threshold_percentage, current_time):
    ...
    def send_insufficient_liquidity_alert(self, instrument_name, total_depth, current_time):
